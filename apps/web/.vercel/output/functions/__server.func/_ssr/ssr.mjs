...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-snzLM0tw.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BDZr5KE6.mjs"),
		import("./start-Cyd3YGwP.mjs"),
		import("./empty-plugin-adapters-Bfr5Qqrp.mjs")
	]);
	return {
		routerEntry,
		startEntry,
