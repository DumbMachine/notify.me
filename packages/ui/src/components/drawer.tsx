...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col gap-0.5 p-4 pb-0 text-start md:gap-0.5",
        className
      )}
      {...props}
    />
